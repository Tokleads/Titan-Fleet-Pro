...
function MainSlide({ slide }: { slide: typeof slides[0] }) {
  return (
    <div className="flex-1 grid lg:grid-cols-2 gap-0 overflow-hidden">
      ...
      {/* Right: screenshot */}
      <div className="relative bg-slate-900/50 border-l border-white/10 flex flex-col items-center justify-center p-6">
        <div className="w-full max-h-[75vh] overflow-hidden rounded-xl shadow-2xl border border-white/10">
          <img
